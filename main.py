...
#with open('C:/Users/jacob/Documents/GitHub/Adaptive-Sonar-Route-Planning/test_data/antwerpen_optimal.pkl', 'wb') as file:
#    pickle.dump(optimized_sub_polygons, file)

# Load the optimal sub-polygons
with open('./test_data/antwerpen_optimal.pkl', 'rb') as file:
