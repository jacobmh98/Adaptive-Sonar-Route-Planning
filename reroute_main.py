...
def hard_edges_rerouting(start_point, end_point, region, obstacles, prev_poly):
    ...
    :param prev_poly: The previous polygon in the path sequence.
    ...
    # Region edge intersected, but clear from obstacles
        ...
        return reroute_hard_region_edges.reroute_path_region(start_point, end_point, intersected_region_edges, region)
    ...
    # Obstacle edges intersected
        ...
        return reroute_hard_obstacles.reroute_path_obstacles(start_point, end_point, obstacles, prev_poly, filtered_obstacle_edges)
